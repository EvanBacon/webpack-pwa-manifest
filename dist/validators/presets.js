 ...
 */
'any'];
var VALID_MULTI_PURPOSE_PLATFORMS = ['play', // android
'itunes', // ios
'windows']; // https://developers.google.com/web/fundamentals/web-app-manifest/#icons

var REQUIRED_ICON_SIZES = [192, 512];
var presets = {
  dir: ['ltr', 'rtl', 'auto'],
...
function _default(config) {
  ...
  for (var _i = 0; _i < properties.length; _i++) {
    ...
    if (value && !hasPreset(property, value)) {
      throw new _PresetError.default(property, value);
    }
  }
}